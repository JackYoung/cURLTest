...
public class Bytes {
  ...
  func import8Bits(byte: UInt8) -> Bytes {
    data.append(byte)
    return self
  }
  ...
  /// - returns: The Bytes object
  func import16Bits(short: UInt16) -> Bytes {
  ...
  /// - returns: The Bytes object
  func import32Bits(int: UInt32) -> Bytes {
  ...
  /// - returns: The Bytes object
  func import64Bits(int: UInt64) -> Bytes {
    data.append(UInt8(int & 0xFF))
    data.append(UInt8((int >> 8) & 0xFF))
    data.append(UInt8((int >> 16) & 0xFF))
    data.append(UInt8((int >> 24) & 0xFF))
  ...
  /// - returns: The Bytes object
  func importBytes(bytes: [UInt8]) -> Bytes {
  ...
  /// - returns: The Bytes object
  func importBytes(bytes: Bytes) -> Bytes {
  ...
  /// - returns: The Bytes object
  func importBytes(bytes: ArraySlice<UInt8>) -> Bytes {
    data.appendContentsOf(bytes)
    return self
  }
  ...
  func exportBytes(count: Int) -> [UInt8] {
    var sub = [UInt8]()
